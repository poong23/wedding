$(document).ready(function () {
    ...
    //wedding d-day calc
    var Dday = new Date("2024-03-10"); // D-day(2022년 12월(-1) 10일)를 셋팅한다.
    var now = new Date();
    ...
    $(".main-thx__box-title").each(function () {
        $(this).click(function () {
            ...
            $(this)
                .next(".main-thx__box-bank")
                .toggleClass("main-thx__box-bank--active");
        });
    });
    ...
    function bgm_player() {
        ...
        if (bgm.paused) {
            ...
            $(".main-visual__btn")
                .find("img")
                .attr("src", "assets/images/icon/icon_music_off.svg");
        } else {
            bgm.pause();
            $(".main-visual__btn")
                .find("img")
                .attr("src", "assets/images/icon/icon_music_on.svg");
        }
    }
